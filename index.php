...
# Default
$_OPTIMIZATION = array();
$_OPTIMIZATION["title"] = "Clash of Clans";
$_OPTIMIZATION["description"] = "Игра с выводом денег";
$_OPTIMIZATION["keywords"] = "Заработок на игре, карты, вложения, заработать, ферма, денежная ферма, заработать играя";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "faq": include("pages/_faq.php"); break; // Пользователи
				case "stat": include("pages/_stat.php"); break; // Статистика
								...
								case "qest": include("pages/_qest.php"); break; // Чат
								case "chat": include("pages/_chat.php"); break; // Чат
				
				case "area": include("pages/_admin.php"); break; // Админка
